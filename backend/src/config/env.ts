...
const envSchema = z.object({
  ...
  ENCRYPTION_KEY: z.string().min(32, 'ENCRYPTION_KEY must be at least 32 characters'), // Required for AES-256-GCM encryption of sensitive fields (Aadhaar, PAN, bank accounts)
