...
export class InternController {
  async getProfile(req: Request, res: Response, next: NextFunction) {
    try {
      const profile = await internService.getProfile(req.params.employeeId);
  ...
  async createProfile(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const profile = await internService.createProfile(req.params.employeeId, data);
  ...
  async updateProfile(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const profile = await internService.updateProfile(req.params.employeeId, data);
  ...
  async getAchievementLetters(req: Request, res: Response, next: NextFunction) {
    try {
      const letters = await internService.getAchievementLetters(req.params.employeeId);
  ...
  async issueAchievementLetter(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const letter = await internService.issueAchievementLetter(req.params.employeeId, data);
  ...
  async downloadAchievementLetterPdf(req: Request, res: Response, next: NextFunction) {
    try {
      const pdfBuffer = await internService.generateAchievementLetterPdf(req.params.letterId);
