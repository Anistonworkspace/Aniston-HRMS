  ...
  return (
    <>
      ...
      <button onClick={() => setOpen(!open)}
        className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-brand-600 text-white shadow-lg hover:bg-brand-700 transition-all flex items-center justify-center group"
        title="AI Assistant">
